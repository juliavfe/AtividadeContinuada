...
public class TesteEquipamentoMediator extends TesteAbstrato {
    ...
    private static final String DESCRICAO_NAO_INFORMADA = "Descri��o n�o informada";
    private static final String DESCRICAO_TEM_MENOS_DE_10_CARACTERES = "Descri��o tem menos de 10 caracteres";
    private static final String DESCRICAO_TEM_MAIS_DE_150_CARACTERES = "Descri��o tem mais de 150 caracteres";
